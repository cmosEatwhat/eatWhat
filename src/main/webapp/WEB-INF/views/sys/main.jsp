	...
	<div class="row">
		<div class="sysNotice col">
			...
			<div class="layui-elem-quote layui-quote-nm">
				<h3>V2.0.4 - 2018-05-06</h3>
				<p>* 数据库支持了SQLserver,只需修改配置文件即可实现数据库之间的转换。</p>
				<p>* 系统工具中加入了定时任务管理和cron生成器，轻松实现系统调度问题。</p>
				<p>* 代码生成器进行了优化，数据库可通过配置文件修改</p>
				<p>* 修复若干bug。</p>
				<br />
		...
		<div class="sysNotice col">
			...
			<table class="layui-table">
				...
				<tbody>
					...
					<tr>
						<td>版本信息</td>
						<td class="homePage">OneManage v2.0.4</td>
					</tr>
					<tr>
						<td>开发作者</td>
